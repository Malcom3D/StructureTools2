...
class Constant:
    ...
    def GammaM(self):
        ...
        self.GammaMList.append(list(map(set_type, ['Glued laminated wood', '1.45', '1.35'])))
    ...
    def Kdef(self):
        ...
        self.KdefList.append(list(map(set_type, ['Particleboard (chipboard)', 'UNI EN 312:2010 Part 4', '2.25', '0.0', '0.0'])))
        self.KdefList.append(list(map(set_type, ['Particleboard (chipboard)', 'UNI EN 312:2010 Part 5', '2.25', '3.00', '0.0'])))
