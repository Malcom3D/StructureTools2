...
class Project:
    ...
    def GeoMode(self):
        ...
        self.LandAreaRadiusValue.setMinimum(259)
        self.LandAreaRadiusValue.valueChanged.connect(self.calcArea)
        self.LandAreaValueLabel = QtGui.QLabel('Land area: 100620 m²')
    ...
    def accept(self):
        ...
        intSurf = objSurface.BSplineSurface()
        intSurf.interpolate(vectors)
        #Part.show(intSurf.toShape())
        objSurface.show(intSurf.toShape())
